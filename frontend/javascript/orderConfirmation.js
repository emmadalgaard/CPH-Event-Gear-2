window.onload = function getOrderInfo() {
    ...
    document.getElementById('amountOfEventpackage1').innerHTML ="Rund Fødselsdag: " + amount1;
    document.getElementById('amountOfEventpackage2').innerHTML ="Bryllup: " + amount2;
    document.getElementById('amountOfEventpackage3').innerHTML ="Studentergilde: " + amount3;
